...
function likebtn_admin_buttons() 
{
    ...
    <script>(function(d, e, s) {a = d.createElement(e);m = d.getElementsByTagName(e)[0];a.async = 1;a.src = s;m.parentNode.insertBefore(a, m)})(document, 'script', '//<?php echo LIKEBTN_WEBSITE_DOMAIN; ?>/<?php echo esc_attr($likebtn_website_locale) ?>/js/donate_generator.js');
    </script>
    ...
    <?php foreach ($likebtn_buttons_options as $option_name => $option_value): ?>
        ...
        <?php endif ?>
        reset_settings['<?php echo str_replace('likebtn_', '', esc_attr($option_name)); ?>'] = '<?php echo esc_attr($option_value) ?>';
    <?php endforeach ?>
    <?php foreach ($likebtn_settings as $option_name => $option_info): ?>
        reset_settings['settings_<?php echo esc_attr($option_name) ?>'] = '<?php echo esc_attr($option_info['default']) ?>';
    <?php endforeach ?>
        var likebtn_sci = [];
    <?php foreach ($likebtn_buttons_options_shortcode as $option_name => $option_value): ?>
        <?php if (is_array($option_value)): ?>
            <?php $option_value = array_shift($option_value); ?>
        <?php endif ?>
        likebtn_sci['<?php echo esc_attr($option_value) ?>'] = '';
    <?php endforeach ?>
    ...
    <div>
        <form method="post" action="options.php" onsubmit="return likebtnOnSaveButtons()" id="settings_form" autocomplete="off">
            ...
            <input type="hidden" name="likebtn_subpage" value="<?php echo esc_attr($subpage); ?>" id="likebtn_entity_name_field">
                    ...
                    <div class="inside entity_tab_container">
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <input type="checkbox" name="likebtn_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_show_' . $entity_name)); ?> onClick="entityShowChange(this, '<?php echo esc_attr($entity_name); ?>')" />
                                </td>
                            </tr>
                        </table>

                        <div id="entity_container_<?php echo esc_attr($entity_name); ?>" <?php if (!get_option('likebtn_show_' . $entity_name)): ?>style="display:none"<?php endif ?>>
                            <table class="form-table" >
                                <tr valign="top">
                                    ...
                                    <td>
                                        <select name="likebtn_use_settings_from_<?php echo esc_attr($entity_name); ?>" onChange="userSettingsFromChange(this, '<?php echo esc_attr($entity_name); ?>')">
                            ...
                            <div id="use_settings_from_container_<?php echo esc_attr($entity_name); ?>" <?php if (get_option('likebtn_use_settings_from_' . $entity_name)): ?>style="display:none"<?php endif ?>>
                                    ...
                                    <div class="inside">
                                        ...
                                        <table class="form-table">
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="radio" name="likebtn_theme_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_THEME_TYPE_PREDEFINED; ?>" <?php if (LIKEBTN_THEME_TYPE_PREDEFINED == get_option('likebtn_theme_type_' . $entity_name) || !get_option('likebtn_theme_type_' . $entity_name)): ?>checked="checked"<?php endif ?> class="theme_type_radio" /> 

                                                    <select name="likebtn_settings_theme_<?php echo esc_attr($entity_name); ?>" class="image_dropdown" id="settings_theme">
                                                        <?php foreach ($style_options as $style): ?>
                                                            <option value="<?php echo esc_attr($style); ?>" <?php selected($style, get_option('likebtn_settings_theme_' . $entity_name)); ?> ></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <br/><br/>
                                                    <label>
                                                        <input type="radio" name="likebtn_theme_type_<?php echo esc_attr($entity_name); ?>" class="theme_type_radio" value="<?php echo LIKEBTN_THEME_TYPE_CUSTOM; ?>" <?php if (LIKEBTN_THEME_TYPE_CUSTOM == get_option('likebtn_theme_type_' . $entity_name)): ?>checked="checked"<?php endif ?> /> 
                                                        <?php _e('Custom theme & image', 'likebtn-like-button'); ?>
                                                    </label>
                                                    <input type="hidden" name="likebtn_settings_theme_<?php echo esc_attr($entity_name); ?>" id="settings_theme_custom" value="custom" <?php if (LIKEBTN_THEME_TYPE_CUSTOM != get_option('likebtn_theme_type_' . $entity_name)): ?> class="disabled" disabled="disabled"<?php endif ?> />
                                                </td>
                                            </tr>
                                            ...
                                            <tr valign="top" class="likebtn_custom hidden">
                                                ...
                                                <td>
                                                    <input type="radio" name="likebtn_icon_l_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ICON_TYPE_ICON; ?>" <?php if (LIKEBTN_ICON_TYPE_ICON == get_option('likebtn_icon_l_type_' . $entity_name) || !get_option('likebtn_icon_l_type_' . $entity_name)): ?>checked="checked"<?php endif ?> class="icon_l_type_radio" /> 
                                                    <select name="likebtn_settings_icon_l_<?php echo esc_attr($entity_name); ?>" id="settings_icon_l" class="icon_dropdown likebtn_i_sm <?php if (LIKEBTN_ICON_TYPE_ICON != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_ICON != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?> >
                                                        <?php foreach ($likebtn_icons as $icon): ?>
                                                            <option value="<?php echo esc_attr($icon); ?>" <?php selected($icon, get_option('likebtn_settings_icon_l_' . $entity_name)); ?> ><?php echo esc_attr($icon); ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <br/><br/>
                                                    <ul class="likebtn-is">
                                                        <li class="likebtn-is-radio">
                                                            <input type="radio" name="likebtn_icon_l_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ICON_TYPE_URL; ?>" <?php if (LIKEBTN_ICON_TYPE_URL == get_option('likebtn_icon_l_type_' . $entity_name)): ?>checked="checked"<?php endif ?> class="icon_l_type_radio" /> 
                                                        </li>
                                                        <li class="likebtn-is-block likebtn-is-frst">
                                                            ...
                                                            <a title="<?php _e('Select Icon', 'likebtn-like-button'); ?>" class="<?php if (!$likebtn_icon_url): ?>button button-large <?php endif ?>likebtn-i-pick" data-likebtn-wp-title="<?php _e('Like Icon', 'likebtn-like-button'); ?>">
                                                                    ...
                                                                    <img class="attachment-medium<?php if (!$likebtn_icon_url): ?> hidden<?php endif?>" src="<?php echo esc_attr($likebtn_icon_url); ?> " />
                                                            </a>
                                                            ...
                                                            <input type="hidden" name="likebtn_settings_icon_l_url_<?php echo esc_attr($entity_name); ?>" id="settings_icon_l_url" value="<?php echo esc_attr($likebtn_icon_url); ?>" class="likebtn-is-inp <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?> /> 
                                                        </li>
                                                        <li class="likebtn-is-block">
                                                            ...
                                                            <div class="likebtn-is-remove <?php if (!$likebtn_icon_url): ?> hidden<?php endif?>"><a onclick="likebtnIconRemove(this);return false;" href="#"><?php _e('Remove', 'likebtn-like-button'); ?></a></div>
                                                            <input type="hidden" name="likebtn_settings_icon_l_url_v_<?php echo esc_attr($entity_name); ?>" id="settings_icon_l_url_v" value="<?php echo esc_attr($likebtn_icon_url); ?>" class="likebtn-is-inp <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_l_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?>/> 
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr valign="top" class="likebtn_custom hidden">
                                                ...
                                                <td>
                                                    <input type="radio" name="likebtn_icon_d_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ICON_TYPE_ICON; ?>" <?php if (LIKEBTN_ICON_TYPE_ICON == get_option('likebtn_icon_d_type_' . $entity_name) || !get_option('likebtn_icon_d_type_' . $entity_name)): ?>checked="checked"<?php endif ?> class="icon_d_type_radio" /> 
                                                    <select name="likebtn_settings_icon_d_<?php echo esc_attr($entity_name); ?>" id="settings_icon_d" class="icon_dropdown likebtn_i_sm <?php if (LIKEBTN_ICON_TYPE_ICON != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_ICON != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?> >
                                                        <?php foreach ($likebtn_icons as $icon): ?>
                                                            <option value="<?php echo esc_attr($icon); ?>" <?php selected($icon, get_option('likebtn_settings_icon_d_' . $entity_name)); ?> ><?php echo esc_attr($icon); ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <br/><br/>
                                                    <ul class="likebtn-is">
                                                        <li class="likebtn-is-radio">
                                                            <input type="radio" name="likebtn_icon_d_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ICON_TYPE_URL; ?>" <?php if (LIKEBTN_ICON_TYPE_URL == get_option('likebtn_icon_d_type_' . $entity_name)): ?>checked="checked"<?php endif ?> class="icon_d_type_radio" /> 
                                                        </li>
                                                        <li class="likebtn-is-block likebtn-is-frst">
                                                            <?php _e('Image', 'likebtn-like-button'); ?>
                                                            <br/>
                                                            ...
                                                            <div class="likebtn-is-remove <?php if (!$likebtn_icon_url): ?> hidden<?php endif?>"><a onclick="likebtnIconRemove(this);return false;" href="#"><?php _e('Remove', 'likebtn-like-button'); ?></a></div>
                                                            <input type="hidden" name="likebtn_settings_icon_d_url_<?php echo esc_attr($entity_name); ?>" id="settings_icon_d_url" value="<?php echo esc_attr($likebtn_icon_url); ?>" class="likebtn-is-inp <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?> /> 
                                                        </li>
                                                        <li class="likebtn-is-block">
                                                            <?php _e('Image after voting', 'likebtn-like-button'); ?>
                                                            <br/>
                                                            ...
                                                            <div class="likebtn-is-remove <?php if (!$likebtn_icon_url): ?> hidden<?php endif?>"><a onclick="likebtnIconRemove(this);return false;" href="#"><?php _e('Remove', 'likebtn-like-button'); ?></a></div>
                                                            <input type="hidden" name="likebtn_settings_icon_d_url_v_<?php echo esc_attr($entity_name); ?>" id="settings_icon_d_url_v" value="<?php echo esc_attr($likebtn_icon_url); ?>" class="likebtn-is-inp <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled<?php endif ?>" <?php if (LIKEBTN_ICON_TYPE_URL != get_option('likebtn_icon_d_type_' . $entity_name)): ?>disabled="disabled"<?php endif ?>/> 
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            ...
                                            <tr valign="top" class="likebtn_custom hidden">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_f_family_<?php echo esc_attr($entity_name); ?>" class="likebtn_i_sm">
                                                        <?php foreach ($likebtn_fonts as $font): ?>
                                                            <option value="<?php echo esc_attr($font); ?>" <?php selected($font, get_option('likebtn_settings_f_family_' . $entity_name)); ?> style="font-family: '<?php echo esc_attr($font) ?>'"><?php echo esc_html($font) ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr valign="top" class="likebtn_custom hidden">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_label_fs_<?php echo esc_attr($entity_name); ?>" class="likebtn_i_sm">
                                                        <?php foreach ($likebtn_fstyles as $fstyle => $fstyle_opts): ?>
                                                            <option value="<?php echo esc_attr($fstyle); ?>" <?php selected($fstyle, get_option('likebtn_settings_label_fs_' . $entity_name)); ?> style="<?php echo esc_attr($fstyle_opts['css']); ?>"><?php echo esc_attr($fstyle_opts['name']) ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr valign="top" class="likebtn_custom hidden">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_counter_fs_<?php echo esc_attr($entity_name); ?>" class="likebtn_i_sm">
                                                        <?php foreach ($likebtn_fstyles as $fstyle => $fstyle_opts): ?>
                                                            <option value="<?php echo esc_attr($fstyle); ?>" <?php selected($fstyle, get_option('likebtn_settings_counter_fs_' . $entity_name)); ?> style="<?php echo esc_attr($fstyle_opts['css']); ?>"><?php echo esc_attr($fstyle_opts['name']) ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_lang_<?php echo esc_attr($entity_name); ?>" id="settings_lang" class="likebtn_i_sm">
                                                        <?php foreach ($languages as $lang_code => $lang_info): ?>
                                                            <option value="<?php echo esc_attr($lang_code); ?>" <?php selected($lang_code, get_option('likebtn_settings_lang_' . $entity_name)); ?> title="<?php echo esc_attr($lang_info['en_name']); ?>">[<?php echo esc_attr($lang_code); ?>] <?php echo esc_attr($lang_info['name']); ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" name="likebtn_settings_like_enabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_like_enabled_' . $entity_name)); ?> />
                                                    <i><?php _e('Like', 'likebtn-like-button'); ?></i>
                                                    &nbsp;&nbsp;
                                                    <input type="checkbox" name="likebtn_settings_dislike_enabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_dislike_enabled_' . $entity_name)); ?> />
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" name="likebtn_settings_show_like_label_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_show_like_label_' . $entity_name)); ?> />
                                                    <i><?php _e('Like', 'likebtn-like-button'); ?></i>
                                                    &nbsp;&nbsp;
                                                    <input type="checkbox" name="likebtn_settings_show_dislike_label_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_show_dislike_label_' . $entity_name)); ?> />
                                                    <i><?php _e('Dislike', 'likebtn-like-button'); ?></i>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                 ...
                                                 <td>
                                                     <input type="checkbox" name="likebtn_settings_icon_like_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_icon_like_show_' . $entity_name)); ?> />
                                                     <i><?php _e('Like', 'likebtn-like-button'); ?></i>
                                                     &nbsp;&nbsp;
                                                     <input type="checkbox" name="likebtn_settings_icon_dislike_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_icon_dislike_show_' . $entity_name)); ?> />
                                                     <i><?php _e('Dislike', 'likebtn-like-button'); ?></i>
                                                 </td>
                                             </tr>
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_counter_type_<?php echo esc_attr($entity_name); ?>" class="image_dropdown" id="settings_counter_type">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" name="likebtn_settings_vert_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_vert_' . $entity_name)); ?> />
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><label><?php _e('Show tooltips', 'likebtn-like-button'); ?></label></th>
                                                <td>
                                                    <input type="checkbox" name="likebtn_settings_tooltip_enabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_tooltip_enabled_' . $entity_name)); ?> />
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <select name="likebtn_settings_ef_voting_<?php echo esc_attr($entity_name); ?>" id="settings_ef_voting" class="likebtn_i_sm">
                                                        <option value=""></option>
                                                        <?php foreach ($likebtn_voting_effects as $voting_effect): ?>
                                                            <option value="<?php echo esc_attr($voting_effect); ?>" <?php selected($voting_effect, get_option('likebtn_settings_ef_voting_' . $entity_name)); ?>><?php echo esc_html($voting_effect); ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr valign="top" class="plan_dependent plan_vip">
                                                ...
                                                <td style="padding-bottom: 0">
                                                    <input type="checkbox" name="likebtn_settings_white_label_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_white_label_' . $entity_name)); ?> /><br/><br/>
                                            ...
                                            <?php if (empty($likebtn_entities_config['likebtn_alignment'][$entity_name]['hide'])): ?>
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <input type="radio" name="likebtn_alignment_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ALIGNMENT_LEFT; ?>" <?php if (LIKEBTN_ALIGNMENT_LEFT == get_option('likebtn_alignment_' . $entity_name) || !get_option('likebtn_alignment_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Left'); ?>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="likebtn_alignment_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ALIGNMENT_CENTER; ?>" <?php if (LIKEBTN_ALIGNMENT_CENTER == get_option('likebtn_alignment_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Center'); ?>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="likebtn_alignment_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_ALIGNMENT_RIGHT; ?>" <?php if (LIKEBTN_ALIGNMENT_RIGHT == get_option('likebtn_alignment_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Right'); ?>
                                            ...
                                            <?php if (empty($likebtn_entities_config['likebtn_position'][$entity_name]['hide'])): ?>
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <input type="radio" name="likebtn_position_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POSITION_TOP ?>" <?php if (LIKEBTN_POSITION_TOP == get_option('likebtn_position_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Top of Content', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="likebtn_position_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POSITION_BOTTOM ?>" <?php if (LIKEBTN_POSITION_BOTTOM == get_option('likebtn_position_' . $entity_name) || !get_option('likebtn_position_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Bottom of Content', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" name="likebtn_position_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POSITION_BOTH ?>" <?php if (LIKEBTN_POSITION_BOTH == get_option('likebtn_position_' . $entity_name)): ?>checked="checked"<?php endif ?> /> <?php _e('Top and Bottom', 'likebtn-like-button'); ?>
                                                ...
                                                <table class="form-table" >
                                                    <?php /*if (!in_array($entity_name, $likebtn_no_excerpts)): ?>
                                                        <tr valign="top">
                                                            ...
                                                            <td>
                                                                <input type="radio" name="likebtn_post_view_mode_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POST_VIEW_MODE_FULL; ?>" <?php checked(LIKEBTN_POST_VIEW_MODE_FULL, get_option('likebtn_post_view_mode_' . $entity_name)) ?> /> <?php _e('Full', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                                <input type="radio" name="likebtn_post_view_mode_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POST_VIEW_MODE_EXCERPT; ?>" <?php checked(LIKEBTN_POST_VIEW_MODE_EXCERPT, get_option('likebtn_post_view_mode_' . $entity_name)) ?> /> <?php _e('Excerpt', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                                <input type="radio" name="likebtn_post_view_mode_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_POST_VIEW_MODE_BOTH; ?>" <?php checked(LIKEBTN_POST_VIEW_MODE_BOTH, get_option('likebtn_post_view_mode_' . $entity_name)) ?> /> <?php _e('Both', 'likebtn-like-button'); ?>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_post_format_<?php echo esc_attr($entity_name); ?>[]" value="all" <?php if (in_array('all', get_option('likebtn_post_format_' . $entity_name))): ?>checked="checked"<?php endif ?> onClick="postFormatAllChange(this, '<?php echo esc_attr($entity_name); ?>')" /> <?php _e('All', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                            <span id="post_format_container_<?php echo esc_attr($entity_name); ?>" <?php if (in_array('all', get_option('likebtn_post_format_' . $entity_name))): ?>style="display:none"<?php endif ?>>
                                                                <?php foreach ($post_formats as $post_format): ?>
                                                                    <input type="checkbox" name="likebtn_post_format_<?php echo esc_attr($entity_name); ?>[]" value="<?php echo esc_attr($post_format); ?>" <?php if (in_array($post_format, get_option('likebtn_post_format_' . $entity_name))): ?>checked="checked"<?php endif ?> /> <?php _e(__(ucfirst($post_format), 'likebtn-like-button')); ?>&nbsp;&nbsp;&nbsp;
                                                                <?php endforeach ?>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_exclude_sections_<?php echo esc_attr($entity_name); ?>[]" value="home" <?php if (in_array('home', $excluded_sections)): ?>checked="checked"<?php endif ?> /> <?php _e('Home'); ?>&nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" name="likebtn_exclude_sections_<?php echo esc_attr($entity_name); ?>[]" value="archive" <?php if (in_array('archive', $excluded_sections)): ?>checked="checked"<?php endif ?> /> <?php _e('Archive', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" name="likebtn_exclude_sections_<?php echo esc_attr($entity_name); ?>[]" value="search" <?php if (in_array('search', $excluded_sections)): ?>checked="checked"<?php endif ?> /> <?php _e('Search', 'likebtn-like-button'); ?>&nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" name="likebtn_exclude_sections_<?php echo esc_attr($entity_name); ?>[]" value="category" <?php if (in_array('category', $excluded_sections)): ?>checked="checked"<?php endif ?> /> <?php _e('Category', 'likebtn-like-button'); ?>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <select name='likebtn_exclude_categories_<?php echo esc_attr($entity_name); ?>[]' multiple="multiple" id="likebtn_exclude_categories" class="likebtn_input">
                                                                <?php
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <select name='likebtn_allow_forums_<?php echo esc_attr($entity_name); ?>[]' multiple="multiple" id="likebtn_allow_forums" class="likebtn_input">
                                                                <?php
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="text" name="likebtn_allow_ids_<?php echo esc_attr($entity_name); ?>" value="<?php _e(get_option('likebtn_allow_ids_' . $entity_name)); ?>" class="likebtn_input" />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="text" name="likebtn_exclude_ids_<?php echo esc_attr($entity_name); ?>" value="<?php _e(get_option('likebtn_exclude_ids_' . $entity_name)); ?>" class="likebtn_input" />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <label>
                                                                <input type="radio" class="radio_voter_by" name="likebtn_voter_by_<?php echo esc_attr($entity_name); ?>" value="" <?php checked(LIKEBTN_VOTER_BY_IP, get_option('likebtn_voter_by_' . $entity_name)) ?> /><?php _e('IP + Device + Cookie', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" class="radio_voter_by" name="likebtn_voter_by_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_VOTER_BY_USER; ?>" <?php checked(LIKEBTN_VOTER_BY_USER, get_option('likebtn_voter_by_' . $entity_name)) ?> /><?php _e('Username', 'likebtn-like-button'); ?>
                                                            </label>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_ALL, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show to all', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_USER_LOGGED_IN_YES; ?>" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_YES, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show to <strong>logged in</strong> users only', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_USER_LOGGED_IN_NO; ?>" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_NO, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show to <strong>guests</strong> only', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_USER_LOGGED_IN_ALERT; ?>" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_ALERT, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show a <strong>message</strong> asking to login instead of the button to guests', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_USER_LOGGED_IN_ALERT_BTN; ?>" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_ALERT_BTN, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show a <strong>message</strong> asking to login <strong>and the button</strong> to guests', 'likebtn-like-button'); ?>
                                                            </label>
                                                            <br/>
                                                            <label>
                                                                <input type="radio" name="likebtn_user_logged_in_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_USER_LOGGED_IN_MODAL; ?>" class="user_logged_in_radio" <?php checked(LIKEBTN_USER_LOGGED_IN_MODAL, get_option('likebtn_user_logged_in_' . $entity_name)) ?> /><?php _e('Show a <strong>modal window</strong> with the message asking to login when guest votes', 'likebtn-like-button'); ?>
                                                            </label>
           ...
           __('Make sure not to disable anonymous access to %admin_ajax%, otherwise votes from anonymous visitors will not be accepted.', 'likebtn-like-button'), 
            array('%admin_ajax%'=>'<a href="'.admin_url('admin-ajax.php').'" target="_blank">/wp-admin/admin-ajax.php</a>')) ?></p>
                                                            ...
                                                            <p class="description param_user_logged_in_alert hidden">
                                                                ...
                                                                <textarea name="likebtn_user_logged_in_alert_<?php echo esc_attr($entity_name); ?>" class="likebtn_input" rows="2"><?php echo htmlspecialchars($user_logged_in_alert); ?></textarea>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_<?php echo esc_attr($entity_name); ?>" value="" class="like_box_radio" <?php checked('', get_option('likebtn_like_box_' . $entity_name)) ?> /><?php _e('Disabled', 'likebtn-like-button'); ?>
                                                            </label>
                                                            &nbsp;&nbsp;&nbsp; 
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_LIKE_BOX_AFTER; ?>" class="like_box_radio" <?php checked(LIKEBTN_LIKE_BOX_AFTER, get_option('likebtn_like_box_' . $entity_name)) ?> /><?php _e('After the button', 'likebtn-like-button'); ?>
                                                            </label>
                                                            &nbsp;&nbsp;&nbsp; 
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_LIKE_BOX_BEFORE; ?>" class="like_box_radio" <?php checked(LIKEBTN_LIKE_BOX_BEFORE, get_option('likebtn_like_box_' . $entity_name)) ?> /><?php _e('Before the button', 'likebtn-like-button'); ?>
                                                            </label>
                                                    ...
                                                    <tr valign="top" class="param_like_box hidden">
                                                        ...
                                                        <td>
                                                            <input type="number" name="likebtn_like_box_size_<?php echo esc_attr($entity_name); ?>" value="<?php echo (get_option('likebtn_like_box_size_' . $entity_name) ? get_option('likebtn_like_box_size_' . $entity_name) : $likebtn_buttons_options['likebtn_like_box_size']); ?>" class="likebtn_input likebtn_i_sm" min="1" maxlength="3"/> (<?php _e('users', 'likebtn-like-button'); ?>)
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" class="param_like_box hidden">
                                                        ...
                                                        <td>
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_VOTE_LIKE; ?>" <?php if (get_option('likebtn_like_box_type_' . $entity_name) == LIKEBTN_VOTE_LIKE || get_option('likebtn_like_box_type_' . $entity_name) == ''): ?>checked="checked"<?php endif ?> /><?php _e('Likers', 'likebtn-like-button'); ?>
                                                            </label>
                                                            &nbsp;&nbsp;&nbsp; 
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_VOTE_DISLIKE; ?>" <?php checked(LIKEBTN_VOTE_DISLIKE, get_option('likebtn_like_box_type_' . $entity_name)) ?> /><?php _e('Dislikers', 'likebtn-like-button'); ?>
                                                            </label>
                                                            &nbsp;&nbsp;&nbsp; 
                                                            <label>
                                                                <input type="radio" name="likebtn_like_box_type_<?php echo esc_attr($entity_name); ?>" value="<?php echo LIKEBTN_VOTE_BOTH; ?>" <?php checked(LIKEBTN_VOTE_BOTH, get_option('likebtn_like_box_type_' . $entity_name)) ?> /><?php _e('Likers & dislikers', 'likebtn-like-button'); ?>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" class="param_like_box hidden">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_newline_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_newline_' . $entity_name)) ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_wrap_<?php echo esc_attr($entity_name); ?>" value="1" class="likebtn_wrap" <?php checked('1', get_option('likebtn_wrap_' . $entity_name)) ?> />
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr valign="top" class="plan_dependent plan_vip">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_popup_disabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_popup_disabled_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Show popup on disliking', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_popup_dislike_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_popup_dislike_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Show popup on button load', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_popup_on_load_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_popup_on_load_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <div class="image_toggle">
                                                                <input type="radio" name="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_top" value="top" <?php checked('top', get_option('likebtn_settings_popup_position_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_top"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_position/top.png" alt="<?php _e('top', 'likebtn-like-button'); ?>" title="<?php _e('top', 'likebtn-like-button'); ?>" /></label>

                                                                <input type="radio" name="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_right" value="right" <?php checked('right', get_option('likebtn_settings_popup_position_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_right"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_position/right.png" alt="<?php _e('right', 'likebtn-like-button'); ?>" title="<?php _e('right', 'likebtn-like-button'); ?>" /></label>

                                                                <input type="radio" name="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_bottom" value="bottom" <?php checked('bottom', get_option('likebtn_settings_popup_position_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_bottom"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_position/bottom.png" alt="<?php _e('bottom', 'likebtn-like-button'); ?>" title="<?php _e('bottom', 'likebtn-like-button'); ?>" /></label>

                                                                <input type="radio" name="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_left" value="left" <?php checked('left', get_option('likebtn_settings_popup_position_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_position_<?php echo esc_attr($entity_name); ?>_left"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_position/left.png" alt="<?php _e('left', 'likebtn-like-button'); ?>" title="<?php _e('left', 'likebtn-like-button'); ?>" /></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <div class="image_toggle">
                                                                <input type="radio" name="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>_light" value="light" <?php checked('light', get_option('likebtn_settings_popup_style_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>_light"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_style/light.png" alt="<?php _e('light', 'likebtn-like-button'); ?>" title="<?php _e('light', 'likebtn-like-button'); ?>" /></label>                                                                        
                                                                <input type="radio" name="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>_dark" value="dark" <?php checked('dark', get_option('likebtn_settings_popup_style_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_popup_style_<?php echo esc_attr($entity_name); ?>_dark"><img src="<?php echo _likebtn_get_public_url() ?>img/popup_style/dark.png" alt="<?php _e('dark', 'likebtn-like-button'); ?>" title="<?php _e('dark', 'likebtn-like-button'); ?>" /></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_popup_hide_on_outside_click_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_popup_hide_on_outside_click_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" class="plan_dependent plan_vip">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="likebtn_settings_popup_donate_<?php echo esc_attr($entity_name); ?>" value="<?php echo htmlspecialchars(get_option('likebtn_settings_popup_donate_' . $entity_name)); ?>" id="popup_donate_input" class="likebtn_input"/>
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_voting_enabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_voting_enabled_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Allow to cancel a vote', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_voting_cancelable_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_voting_cancelable_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Allow to like and dislike at the same time', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_voting_both_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_voting_both_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <select name="likebtn_settings_voting_frequency_<?php echo esc_attr($entity_name); ?>">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_voting_author_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_voting_author_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <select name="likebtn_voting_period_<?php echo esc_attr($entity_name); ?>" class="likebtn_input voting_period" id="likebtn_voting_period">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_voting_one_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_voting_one_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                 <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_counter_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_counter_show_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Votes counter is clickable', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_counter_clickable_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_counter_clickable_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <select name="likebtn_settings_counter_frmt_<?php echo esc_attr($entity_name); ?>">
           ...
           __('For example set the following mask "0000000" if you need the counter to be displayed as 0000001, 0000002 after receiving first, second and so on votes. This parameter does not set value for buttons. If you need to set number of votes for buttons please do so on Statistics tab.', 'likebtn-like-button')) ?></p>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_counter_zero_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_counter_zero_show_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Animate number counting', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_counter_count_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_counter_count_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr valign="top" class="plan_dependent plan_plus">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_share_enabled_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_share_enabled_' . $entity_name)); ?> />
                                                        ...
                                                        <td>
                                                            <select id="settings_addthis_service_codes" class="likebtn_at16 likebtn_input" multiple="multiple" >
                                                                <?php foreach($likebtn_addthis_service_codes as $addthis_service_code): ?>
                                                                    <option value="<?php echo esc_attr($addthis_service_code) ?>"><?php echo esc_html($addthis_service_code) ?></option>
                                                                <?php endforeach ?>
                                                            </select>

                                                            <input type="hidden" name="likebtn_settings_addthis_service_codes_<?php echo esc_attr($entity_name); ?>" value="<?php echo esc_attr($value_addthis_service_codes); ?>" class="likebtn_input" id="settings_addthis_service_codes_input"/>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <div class="image_toggle">
                                                                <input type="radio" name="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_small" value="small" <?php checked('small', get_option('likebtn_settings_share_size_' . $entity_name)); ?> >
                                                                <label for="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_small"><img src="<?php echo _likebtn_get_public_url() ?>img/share_size/small.png" alt="<?php _e('small', 'likebtn-like-button'); ?>" title="<?php _e('small', 'likebtn-like-button'); ?>" /></label>

                                                                <input type="radio" name="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_medium" value="medium" <?php checked('medium', get_option('likebtn_settings_share_size_' . $entity_name)); ?><?php checked('', get_option('likebtn_settings_share_size_' . $entity_name)); ?> >
                                                                <label for="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_medium"><img src="<?php echo _likebtn_get_public_url() ?>img/share_size/medium.png" alt="<?php _e('medium', 'likebtn-like-button'); ?>" title="<?php _e('medium', 'likebtn-like-button'); ?>" /></label>

                                                                <input type="radio" name="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>" id="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_large" value="large" <?php checked('large', get_option('likebtn_settings_share_size_' . $entity_name)); ?>>
                                                                <label for="likebtn_settings_share_size_<?php echo esc_attr($entity_name); ?>_large"><img src="<?php echo _likebtn_get_public_url() ?>img/share_size/large.png" alt="<?php _e('large', 'likebtn-like-button'); ?>" title="<?php _e('large', 'likebtn-like-button'); ?>" /></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" class="plan_dependent plan_pro">
                                                    ...
                                                    <?php if (empty($likebtn_entities_config['likebtn_og'][$entity_name]['hide'])): ?>
                                                        <tr valign="top">
                                                            ...
                                                            <td>
                                                                <input type="checkbox" name="likebtn_og_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_og_' . $entity_name_clean)); ?> />
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_tooltip_like_show_always_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_tooltip_like_show_always_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <th scope="row"><label><?php _e('Always show Dislike button tooltip', 'likebtn-like-button'); ?></label></th>
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_tooltip_dislike_show_always_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_tooltip_dislike_show_always_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_lazy_load_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_lazy_load_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_loader_show_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_loader_show_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td class="description">
                                                            <input type="text" name="likebtn_settings_event_handler_<?php echo esc_attr($entity_name); ?>" value="<?php _e(get_option('likebtn_settings_event_handler_' . $entity_name)); ?>" class="likebtn_input" />
                                                            <p class="description">
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_settings_rtl_<?php echo esc_attr($entity_name); ?>" value="1" <?php checked('1', get_option('likebtn_settings_rtl_' . $entity_name)); ?> />
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                            ...
                                            <div class="inside">
                                                <table class="form-table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_bp_notify_<?php echo esc_attr($entity_name_clean); ?>" value="1" <?php checked('1', get_option('likebtn_bp_notify_' . $entity_name_clean)) ?> <?php if (!_likebtn_is_bp_active()): ?>disabled="disabled"<?php endif ?> />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_bp_activity_<?php echo esc_attr($entity_name_clean); ?>" value="1" class="bp_activity" <?php checked('1', get_option('likebtn_bp_activity_' . $entity_name_clean)) ?> <?php if (!_likebtn_is_bp_active()): ?>disabled="disabled"<?php endif ?> />
                                                    ...
                                                    <tr class="param_bp_hide_sitewide">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_bp_hide_sitewide_<?php echo esc_attr($entity_name_clean); ?>" value="1" <?php checked('1', get_option('likebtn_bp_hide_sitewide_' . $entity_name_clean)) ?> <?php if (!_likebtn_is_bp_active()): ?>disabled="disabled"<?php endif ?> />
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="param_bp_image">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="likebtn_bp_image_<?php echo esc_attr($entity_name_clean); ?>" value="1" <?php checked('1', get_option('likebtn_bp_image_' . $entity_name_clean)) ?> <?php if (!_likebtn_is_bp_active()): ?>disabled="disabled"<?php endif ?> />
                                                            <br/><br/>
                                                            <?php _e('Snippet template', 'likebtn-like-button'); ?>:
                                                            <br/>
                                                            <textarea name="likebtn_bp_snippet_tpl_<?php echo esc_attr($entity_name); ?>" class="likebtn_input" rows="7"><?php if (get_option('likebtn_bp_snippet_tpl_' . $entity_name)): ?><?php echo htmlspecialchars(get_option('likebtn_bp_snippet_tpl_' . $entity_name)); ?><?php elseif (isset($likebtn_entities_config['bp_snippet_tpl'][$entity_name]['value'])): ?><?php echo htmlspecialchars($likebtn_entities_config['bp_snippet_tpl'][$entity_name]['value']); ?><?php else: ?><?php echo htmlspecialchars(LIKEBTN_BP_SNIPPET_TPL); ?><?php endif ?></textarea>
                                                            <p class="description">
...
add_filter('bp_activity_allowed_tags', 'custom_bp_activity_allowed_tags');</textarea>
                                        ...
                                        <div class="likebtn_reset_wrapper">
                                            ...
                                            <input class="button-secondary" type="button" name="Reset" value="<?php _e('Reset', 'likebtn-like-button'); ?>" onclick="return resetSettings('<?php echo esc_attr($entity_name); ?>', reset_settings)" />
                                        </div>
