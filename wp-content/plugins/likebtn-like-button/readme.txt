...
= 2.6.49 =
* Change - WP 6.3 compatibility.

= 2.6.48 =
* Change - WP 6.2 compatibility.

= 2.6.47 =
* Change - WP 6.1 compatibility.

= 2.6.46 =
* Fix - Fixed an issue with opening PHP tag on PHP > 7.4.

= 2.6.45 =
* Fix - Improved ajax security.

= 2.6.44 =
* Change - WP 6.0 compatibility.

= 2.6.43 =
* Fix - Fixed security issue.

= 2.6.42 =
* Fix - Fixed JS error in LikeBtn widget on Widgets page.

= 2.6.41 =
* Fix - Fixed JS error for custom MyCRED point types.

= 2.6.40 =
* Fix - Fixed notice in admin area.

= 2.6.39 =
* Fix - Improved sanitizing.

= 2.6.38 =
* Fix - Improved ajax security.

= 2.6.37 =
* Change - WP 5.8 compatibility.
...
= 2.6.30 =
* Fix - Fixed JS error on Buttons tab.
